...
pins! {
    CLK: [PC12<Alternate<PushPull>>]
    CMD: [PD2<Alternate<PushPull>>]
    D0: [PC8<Alternate<PushPull>>]
    D1: [PC9<Alternate<PushPull>>]
    D2: [PC10<Alternate<PushPull>>]
    D3: [PC11<Alternate<PushPull>>]
}
